---
dg-publish: true
dg-permalink: sessoes/diario-das-sessoes
tags:
  - portal-jogadores
  - publico
  - sessoes
...
> Recaps públicos da campanha.  
> Aqui ficam apenas os resumos que os jogadores podem consultar sem spoilers de mestre.
...
1. **Sessão 00 — Setup e Entrada na Névoa**  
   Vocês conheceram o tom da campanha, os personagens e os eventos que levaram cada um até a névoa.
...
Este diário guarda apenas o resumo público da campanha.

Ele não contém:

- segredos de mestre;
- estatísticas de inimigos;
- preparação de cenas futuras;
- informações que os personagens ainda não descobriram.

Para rever pistas e documentos encontrados, acesse também:

- [[Itens e Pistas Encontradas|Itens e pistas encontradas]]
- [[Cartas e Documentos|Cartas e documentos]]
- [[Rumores Conhecidos|Rumores conhecidos]]
